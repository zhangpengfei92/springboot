...
layui.define(['layer', 'form'], function(exports){
    ...
    var setIframe = function(editor, textArea, set){
            ...
            var iframeDOM = iframeWin.document
                ...
                fsize:function(){
                   layer.open({
                       ...
                       ,title:false
                       ,closeBtn:0
                       ,content:'<h1 style="text-align: center;padding: 0 5px"> h1</h1>' +
                       '<h2 style="text-align: center;padding: 0 5px"> h2</h2>' +
                       '<h3 style="text-align: center;padding: 0 5px"> h4</h3>' +
                       '<h4 style="text-align: center;padding: 0 5px"> h4</h4>' +
                       '<h5 style="text-align: center;padding: 0 5px"> h5</h5>'
        ...
        ,tools = {
            ...
            ,fsize:'<i class="layui-icon layedit-tool-fsize" title="文字" layedit-event="fsize">&#xe639;</i>'
        }
