layui.define(["jquery"], function (exports) {
    ...
    tree.prototype.template = function (data) {
        ...
        o.each(data, function (index, item) {
            ...
            var st='';
            if(item.aisIntelligentinvestmentType==2&&item.aisIntelligentinvestmentColor!=null){
                st='style="background-color:'+item.aisIntelligentinvestmentColor+';color:#000000"';
            }

            tbody += '<tr '+st+'  data-tb-id="' + item.id + '" data-tb-pid="' + item.pid + '" ' + hide_class + ">";
            o.each(t.c.cols, function (idx, obj) {
                if (obj["data"]) {
