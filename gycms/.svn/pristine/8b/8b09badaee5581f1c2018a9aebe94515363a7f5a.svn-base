...
package com.jcl.gycms.uitl.excle;

import com.jcl.gycms.uitl.excle.converter.DefaultConvertible;
import com.jcl.gycms.uitl.excle.exceptions.Excel4JException;
import com.jcl.gycms.uitl.excle.exceptions.Excel4jReadException;
import com.jcl.gycms.uitl.excle.handler.ExcelHeader;
import com.jcl.gycms.uitl.excle.handler.SheetTemplate;
import com.jcl.gycms.uitl.excle.handler.SheetTemplateHandler;
import com.jcl.gycms.uitl.excle.sheet.wrapper.MapSheetWrapper;
import com.jcl.gycms.uitl.excle.sheet.wrapper.NoTemplateSheetWrapper;
import com.jcl.gycms.uitl.excle.sheet.wrapper.NormalSheetWrapper;
import com.jcl.gycms.uitl.excle.sheet.wrapper.SimpleSheetWrapper;
import com.jcl.gycms.uitl.excle.utils.Utils;
...
public final class ExcelUtils {
     ...
     * @param clazz      待绑定的类(绑定属性注解{@link com.jcl.gycms.uitl.excle..annotation.ExcelField})
    ...
    /**
     * 基于Excel模板与注解{@link com.jcl.gycms.uitl.excle..annotation.ExcelField}导出Excel
     *
    ...
    /**
     * 基于Excel模板与注解{@link com.jcl.gycms.uitl.excle..annotation.ExcelField}导出多sheet的Excel
     *
     ...
     *
     * @param data          待导出数据
     * @param clazz         {@link com.jcl.gycms.uitl.excle..annotation.ExcelField}映射对象Class
     * @param isWriteHeader 是否写入表头
