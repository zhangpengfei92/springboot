...
<div class="layui-fluid" style="background-color: white; padding: 10px">
    <div class="layui-row" >
        <form class="layui-form" action="" method="post" accept-charset="UTF-8">
            ...
            <div class="layui-form-item">
                <label class="layui-form-labels">新密码:</label>
                <div class="layui-input-inline">
                    <input type="text" name="newPwd" placeholder="请输入新密码"  lay-verify="required" autocomplete="off" class="layui-input" >
                </div>
            </div>
