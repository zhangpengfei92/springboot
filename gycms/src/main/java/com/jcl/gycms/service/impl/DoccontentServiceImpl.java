...
public class DoccontentServiceImpl extends BaseService<Doccontent> implements DoccontentService{
	...
	@Override
	public List<Doccontent> getDoccontentByColumId(Integer id,String starttime,String endtime,String title) {
		
		List<Doccontent> list=doccontentMapper.getDoccontentByColumId(id,starttime,endtime,title);
